<%@ Page Language="C#" masterpagefile="~/StJames.master" title="Bulletin for 7 January 2018" %>
...
<table  style="margin-top:10px;" cellspacing="1" border="0" width="100%" >
  	<script language="javascript" type="text/javascript">
		GetHeader("Bulletin Archive: 7 January 2018", "Epiphany"); 
	</script>
</table>
<!-- END HEADER -->
...
fulfillment of a Doctor of Musical Arts degree from
the University of Washington. The program will
feature Healey Willan’s “Introduction, Passacaglia and
Fugue,” Jean Langlais’s “Arabesque for the Flutes,”
...
can be a spouse or partner, child, sibling, friend.
Common feelings include shock, anger, guilt,
depression, confusion and shame. Laura Takacs MPH,
LICSW - clinical director of Virginia Mason’s
Separation and Loss Services, will be addressing the
grief cycle associated with traumatic loss. She will
also talk about a therapeutic model known as
Restorative Retelling groups – with a healing focus on
restoring resilience by honoring the memory of your
loved one and sharing common experiences in a
...
all times. We currently have openings for additional staff. If you like working 
